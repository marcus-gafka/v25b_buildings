...
def estimation_v4(ds, islands=None, debug=False):
    ...
    for idx, (tract_id, buildings) in enumerate(tract_map.items(), 1):
        ...
        # If no residential buildings exist → all zero
        ...
        # -------- POPULATION ALLOCATION (only among RES) --------
        ...
        # -------- VOLUME UNITS ALLOCATION (only among RES) --------
        ...
        # -------- MERGED UNITS ALLOCATION (only among RES) --------
        ALPHA = 0.6
